...
// Se o banco não existir, criar com estrutura definitiva
if (!existsSync(dbPath)) {
  console.log('📊 Criando banco de dados com estrutura definitiva...');
  ...
  const migrations = [
    ...
    CREATE TABLE IF NOT EXISTS non_conformities (
      ...
      priority TEXT CHECK(priority IN ('baixa', 'media', 'alta', 'critica')) NOT NULL,
    ...
    // Criar tabela de participações em treinamentos
    `
